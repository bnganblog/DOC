<template>
  <a
    style="background: var(--vp-c-bg-soft); border-radius: 16px; padding: 16px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); transition: all 0.3s ease; display: flex; align-items: center; justify-between; gap: 16px; height: 100px;"
    :href="data.link"
    target="_blank"
  >
    ...
    <div style="flex: 1; min-width: 0; display: flex; flex-direction: column; justify-content: center; transition: all 0.3s ease;">
      ...
      <div style="color: var(--vp-c-text-2); width: 100%; overflow: hidden; font-size: 14px; line-height: 1.5; font-weight: 400; word-break: break-word; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;" :title="data.descr">
        {{ data.descr }}
      </div>
    </div>
  </a>
