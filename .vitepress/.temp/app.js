...
const VPBackdrop = /* @__PURE__ */ _export_sfc(_sfc_main$16, [["__scopeId", "data-v-54a304ca"]]);
function deserializeFunctions(r) {
  return Array.isArray(r) ? r.map(deserializeFunctions) : typeof r == "object" && r !== null ? Object.keys(r).reduce((t, n) => (t[n] = deserializeFunctions(r[n]), t), {}) : typeof r == "string" && r.startsWith("_vp-fn_") ? new Function(`return ${r.slice(7)}`)() : r;
}
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"归档","description":"A VitePress Site","base":"/doc/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"主页","link":"/"},{"text":"机械加工","items":[{"text":"NXUG12","link":"/pages/MDC/UG12/1"}]},{"text":"关于","items":[{"text":"友情链接","link":"/pages/links"},{"text":"我的博客","link":"https://bnganblog.github.io"}],"style":"color: #3b82f6;"}],"sidebar":{"/pages/MDC/":[{"text":"MDC","collapsible":true,"items":[{"text":"UG12多轴编程","link":"/pages/MDC/UG12/1"},{"text":"UG2512","link":"/pages/MDC/UG2512/1"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/bnganblog"}]},"locales":{},"scrollOffset":134,"cleanUrls":false,"additionalConfig":{}}'));
...
const _sfc_main$15 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "NotFound" }, _attrs))} data-v-b0126292><p class="code" data-v-b0126292>${ssrInterpolate(unref(theme2).notFound?.code ?? "404")}</p><h1 class="title" data-v-b0126292>${ssrInterpolate(unref(theme2).notFound?.title ?? "PAGE NOT FOUND")}</h1><div class="divider" data-v-b0126292></div><blockquote class="quote" data-v-b0126292>${ssrInterpolate(unref(theme2).notFound?.quote ?? "But if you don't change your direction, and if you keep looking, you may end up where you are heading.")}</blockquote><div class="action" data-v-b0126292><a class="link"${ssrRenderAttr("href", unref(withBase)(unref(theme2).notFound?.link ?? unref(currentLang).link))}${ssrRenderAttr("aria-label", unref(theme2).notFound?.linkLabel ?? "go to home")} data-v-b0126292>${ssrInterpolate(unref(theme2).notFound?.linkText ?? "Take me home")}</a></div></div>`);
    };
  }
});
...
const NotFound = /* @__PURE__ */ _export_sfc(_sfc_main$15, [["__scopeId", "data-v-b0126292"]]);
...
const _sfc_main$14 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-63c57e50><!--[-->`);
      ssrRenderList(__props.headers, ({ children, link: link2, title }) => {
        _push(`<li data-v-63c57e50><a class="outline-link"${ssrRenderAttr("href", link2)}${ssrRenderAttr("title", title)} data-v-63c57e50>${ssrInterpolate(title)}</a>`);
        if (children?.length) {
...
const VPDocOutlineItem = /* @__PURE__ */ _export_sfc(_sfc_main$14, [["__scopeId", "data-v-63c57e50"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<nav${ssrRenderAttrs(mergeProps({
        ...
        ref_key: "container",
        ref: container
      }, _attrs))} data-v-c8b19031><div class="content" data-v-c8b19031><div class="outline-marker" data-v-c8b19031></div><div aria-level="2" class="outline-title" id="doc-outline-aria-label" role="heading" data-v-c8b19031>${ssrInterpolate(unref(resolveTitle)(unref(theme2)))}</div>`);
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["__scopeId", "data-v-c8b19031"]]);
...
const VPDocAside = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["__scopeId", "data-v-cb998dce"]]);
...
const _sfc_main$$ = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<p${ssrRenderAttrs(mergeProps({ class: "VPLastUpdated" }, _attrs))} data-v-73dafb42>${ssrInterpolate(unref(theme2).lastUpdated?.text || unref(theme2).lastUpdatedText || "Last updated")}: <time${ssrRenderAttr("datetime", isoDatetime.value)} data-v-73dafb42>${ssrInterpolate(datetime.value)}</time></p>`);
    };
  }
});
...
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["__scopeId", "data-v-73dafb42"]]);
        ...
        if (unref(control).prev?.link || unref(control).next?.link) {
          ...
          if (unref(control).prev?.link) {
            _push(ssrRenderComponent(_sfc_main$10, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<span class="desc" data-v-1bcd8184${_scopeId}>${(unref(theme2).docFooter?.prev || "Previous page") ?? ""}</span><span class="title" data-v-1bcd8184${_scopeId}>${unref(control).prev.text ?? ""}</span>`);
                } else {
                  return [
                    createVNode("span", {
                      class: "desc",
          ...
          if (unref(control).next?.link) {
            _push(ssrRenderComponent(_sfc_main$10, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<span class="desc" data-v-1bcd8184${_scopeId}>${(unref(theme2).docFooter?.next || "Next page") ?? ""}</span><span class="title" data-v-1bcd8184${_scopeId}>${unref(control).next.text ?? ""}</span>`);
                } else {
                  return [
                    createVNode("span", {
                      class: "desc",
...
const VPDocFooter = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["__scopeId", "data-v-1bcd8184"]]);
const _sfc_main$Z = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d668f7cc>`);
      ssrRenderSlot(_ctx.$slots, "doc-top", {}, null, _push, _parent);
      _push(`<div class="container" data-v-d668f7cc>`);
      if (unref(hasAside)) {
        _push(`<div class="${ssrRenderClass([{ "left-aside": unref(leftAside) }, "aside"])}" data-v-d668f7cc><div class="aside-curtain" data-v-d668f7cc></div><div class="aside-container" data-v-d668f7cc><div class="aside-content" data-v-d668f7cc>`);
      ...
      _push(`<div class="content" data-v-d668f7cc><div class="content-container" data-v-d668f7cc>`);
      ssrRenderSlot(_ctx.$slots, "doc-before", {}, null, _push, _parent);
      _push(`<main class="main" data-v-d668f7cc>`);
...
const VPDoc = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["__scopeId", "data-v-d668f7cc"]]);
...
const VPButton = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [["__scopeId", "data-v-58d3b43b"]]);
...
const VPImage = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["__scopeId", "data-v-ab19afbb"]]);
const _sfc_main$W = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-dba860da><div class="container" data-v-dba860da><div class="main" data-v-dba860da>`);
      ...
      ssrRenderSlot(_ctx.$slots, "home-hero-info", {}, () => {
        ...
        if (__props.name) {
          _push(`<span class="name clip" data-v-dba860da>${__props.name ?? ""}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.text) {
          _push(`<span class="text" data-v-dba860da>${__props.text ?? ""}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</h1>`);
        if (__props.tagline) {
          _push(`<p class="tagline" data-v-dba860da>${__props.tagline ?? ""}</p>`);
        } else {
          _push(`<!---->`);
        }
      }, _push, _parent);
...
const VPHero = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["__scopeId", "data-v-dba860da"]]);
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$10, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<article class="box" data-v-83e454c5${_scopeId}>`);
            if (typeof __props.icon === "object" && __props.icon.wrap) {
              _push2(`<div class="icon" data-v-83e454c5${_scopeId}>`);
              ...
              _push2(`<div class="icon" data-v-83e454c5${_scopeId}>${__props.icon ?? ""}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<h2 class="title" data-v-83e454c5${_scopeId}>${__props.title ?? ""}</h2>`);
            if (Array.isArray(__props.details)) {
              _push2(`<ul class="details" data-v-83e454c5${_scopeId}><!--[-->`);
              ssrRenderList(__props.details, (item) => {
                _push2(`<li data-v-83e454c5${_scopeId}>${item ?? ""}</li>`);
              });
              _push2(`<!--]--></ul>`);
            } else if (__props.details) {
              _push2(`<p class="details" data-v-83e454c5${_scopeId}>${__props.details ?? ""}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.linkText) {
              _push2(`<div class="link-text" data-v-83e454c5${_scopeId}><p class="link-text-value" data-v-83e454c5${_scopeId}>${ssrInterpolate(__props.linkText)} <span class="vpi-arrow-right link-text-icon" data-v-83e454c5${_scopeId}></span></p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</article>`);
...
const VPFeature = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["__scopeId", "data-v-83e454c5"]]);
...
const VPFeatures = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["__scopeId", "data-v-b1eea84a"]]);
...
const VPHomeContent = /* @__PURE__ */ _export_sfc(_sfc_main$R, [["__scopeId", "data-v-c141a4bd"]]);
...
const VPHome = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [["__scopeId", "data-v-3f294140"]]);
const _sfc_main$P = {};
...
const VPContent = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["__scopeId", "data-v-529a4999"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(theme2).footer && unref(frontmatter).footer !== false) {
        ...
        }, _attrs))} data-v-5b9946f5><div class="container" data-v-5b9946f5>`);
        if (unref(theme2).footer.message) {
          _push(`<p class="message" data-v-5b9946f5>${unref(theme2).footer.message ?? ""}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(theme2).footer.copyright) {
          _push(`<p class="copyright" data-v-5b9946f5>${unref(theme2).footer.copyright ?? ""}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></footer>`);
...
const VPFooter = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["__scopeId", "data-v-5b9946f5"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref_key: "main",
        ref: main
      }, _attrs))} data-v-e28a51a6>`);
      if (__props.headers.length > 0) {
        _push(`<button class="${ssrRenderClass({ open: open.value })}" data-v-e28a51a6><span class="menu-text" data-v-e28a51a6>${ssrInterpolate(unref(resolveTitle)(unref(theme2)))}</span><span class="vpi-chevron-right icon" data-v-e28a51a6></span></button>`);
      } else {
        _push(`<button data-v-e28a51a6>${ssrInterpolate(unref(theme2).returnToTopLabel || "Return to top")}</button>`);
      }
      if (open.value) {
        _push(`<div class="items" data-v-e28a51a6><div class="header" data-v-e28a51a6><a class="top-link" href="#" data-v-e28a51a6>${ssrInterpolate(unref(theme2).returnToTopLabel || "Return to top")}</a></div><div class="outline" data-v-e28a51a6>`);
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["__scopeId", "data-v-e28a51a6"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!unref(isHome) && (unref(hasLocalNav) || unref(hasSidebar) || unref(y) >= navHeight.value)) {
        ...
        if (unref(hasSidebar)) {
          _push(`<button class="menu"${ssrRenderAttr("aria-expanded", __props.open)} aria-controls="VPSidebarNav" data-v-73add737><span class="vpi-align-left menu-icon" data-v-73add737></span><span class="menu-text" data-v-73add737>${ssrInterpolate(unref(theme2).sidebarMenuLabel || "Menu")}</span></button>`);
        } else {
          _push(`<!---->`);
        }
...
const VPLocalNav = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["__scopeId", "data-v-73add737"]]);
function useNav() {
...
const VPSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-b4ccac88"]]);
...
const VPSwitchAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["__scopeId", "data-v-be9742d9"]]);
...
const VPNavBarAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["__scopeId", "data-v-3f90c1a5"]]);
...
const _sfc_main$H = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "VPMenuLink" }, _attrs))} data-v-6e27a530>`);
      _push(ssrRenderComponent(_sfc_main$10, mergeProps(_ctx.$attrs, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-6e27a530${_scopeId}>${__props.item.text ?? ""}</span>`);
          } else {
            return [
              createVNode("span", {
...
const VPMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["__scopeId", "data-v-6e27a530"]]);
const _sfc_main$G = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.text) {
        _push(`<p class="title" data-v-5474bd6a>${ssrInterpolate(__props.text)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
...
const VPMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["__scopeId", "data-v-5474bd6a"]]);
const _sfc_main$F = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "VPMenu" }, _attrs))} data-v-fcd1d7a8>`);
      if (__props.items) {
        _push(`<div class="items" data-v-fcd1d7a8><!--[-->`);
        ssrRenderList(__props.items, (item) => {
          _push(`<!--[-->`);
          if ("link" in item) {
            _push(ssrRenderComponent(VPMenuLink, { item }, null, _parent));
...
const VPMenu = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["__scopeId", "data-v-fcd1d7a8"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.button || __props.icon) {
        ...
        if (__props.icon) {
          _push(`<span class="${ssrRenderClass([__props.icon, "option-icon"])}" data-v-d8fae6e2></span>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.button) {
          _push(`<span data-v-d8fae6e2>${__props.button ?? ""}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<span class="vpi-chevron-down text-icon" data-v-d8fae6e2></span></span>`);
      } else {
        _push(`<span class="vpi-more-horizontal icon" data-v-d8fae6e2></span>`);
      }
...
const VPFlyout = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["__scopeId", "data-v-d8fae6e2"]]);
const _sfc_main$D = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-32d78712>${svg.value ?? ""}</a>`);
    };
  }
});
...
const VPSocialLink = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["__scopeId", "data-v-32d78712"]]);
const _sfc_main$C = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "VPSocialLinks" }, _attrs))} data-v-a1a7286e><!--[-->`);
...
const VPSocialLinks = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["__scopeId", "data-v-a1a7286e"]]);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(localeLinks).length && unref(currentLang).label) {
                _push2(`<div class="group translations" data-v-2a0cad91${_scopeId}><p class="trans-title" data-v-2a0cad91${_scopeId}>${ssrInterpolate(unref(currentLang).label)}</p><!--[-->`);
              ...
              if (unref(site).appearance && unref(site).appearance !== "force-dark" && unref(site).appearance !== "force-auto") {
                _push2(`<div class="group" data-v-2a0cad91${_scopeId}><div class="item appearance" data-v-2a0cad91${_scopeId}><p class="label" data-v-2a0cad91${_scopeId}>${ssrInterpolate(unref(theme2).darkModeSwitchLabel || "Appearance")}</p><div class="appearance-action" data-v-2a0cad91${_scopeId}>`);
              ...
              if (unref(theme2).socialLinks) {
                _push2(`<div class="group" data-v-2a0cad91${_scopeId}><div class="item social-links" data-v-2a0cad91${_scopeId}>`);
...
const VPNavBarExtra = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["__scopeId", "data-v-2a0cad91"]]);
...
const VPNavBarHamburger = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["__scopeId", "data-v-6bee1efd"]]);
const _sfc_main$z = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$10, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-727dd4ba${_scopeId}>${__props.item.text ?? ""}</span>`);
          } else {
            return [
              createVNode("span", {
                innerHTML: __props.item.text
...
const VPNavBarMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["__scopeId", "data-v-727dd4ba"]]);
const _sfc_main$y = /* @__PURE__ */ defineComponent({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(theme2).nav) {
        _push(`<nav${ssrRenderAttrs(mergeProps({
          ...
          class: "VPNavBarMenu"
        }, _attrs))} data-v-020be4db><span id="main-nav-aria-label" class="visually-hidden" data-v-020be4db> Main Navigation </span><!--[-->`);
...
const VPNavBarMenu = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-020be4db"]]);
...
const VPNavBarAskAiButton = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-f1e7ba13"]]);
const _sfc_main$v = /* @__PURE__ */ defineComponent({
...
const VPNavBarSearchButton = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["__scopeId", "data-v-69351052"]]);
const _sfc_main$u = /* @__PURE__ */ defineComponent({
...
const VPNavBarSearch = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["__scopeId", "data-v-bdd98725"]]);
const _sfc_main$t = /* @__PURE__ */ defineComponent({
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d4488dd0><a class="title"${ssrRenderAttr("href", link2.value ?? unref(normalizeLink$1)(unref(currentLang).link))}${ssrRenderAttr("rel", rel.value)}${ssrRenderAttr("target", target.value)} data-v-d4488dd0>`);
      ...
      if (unref(theme2).siteTitle) {
        _push(`<span data-v-d4488dd0>${unref(theme2).siteTitle ?? ""}</span>`);
      } else if (unref(theme2).siteTitle === void 0) {
        _push(`<span data-v-d4488dd0>${ssrInterpolate(unref(site).title)}</span>`);
      } else {
        _push(`<!---->`);
      }
...
const VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-d4488dd0"]]);
const _sfc_main$r = /* @__PURE__ */ defineComponent({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(localeLinks).length && unref(currentLang).label) {
        _push(ssrRenderComponent(VPFlyout, mergeProps({
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="items" data-v-0b550f38${_scopeId}><p class="title" data-v-0b550f38${_scopeId}>${ssrInterpolate(unref(currentLang).label)}</p><!--[-->`);
              ssrRenderList(unref(localeLinks), (locale) => {
                _push2(ssrRenderComponent(VPMenuLink, {
                  item: locale,
                  lang: locale.lang,
...
const VPNavBarTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["__scopeId", "data-v-0b550f38"]]);
const _sfc_main$q = /* @__PURE__ */ defineComponent({
  __name: "VPNavBar",
  __ssrInlineRender: true,
  props: {
...
const VPNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["__scopeId", "data-v-cc1d9f2e"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$10, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-5f4e26be${_scopeId}>${__props.item.text ?? ""}</span>`);
          } else {
            return [
              createVNode("span", {
                innerHTML: __props.item.text
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-5f4e26be"]]);
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$10, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-bc5d57b6${_scopeId}>${__props.item.text ?? ""}</span>`);
          } else {
            return [
              createVNode("span", {
                innerHTML: __props.item.text
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-bc5d57b6"]]);
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "VPNavScreenMenuGroupSection" }, _attrs))} data-v-7dfe209c>`);
      if (__props.text) {
        _push(`<p class="title" data-v-7dfe209c>${ssrInterpolate(__props.text)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
...
const VPNavScreenMenuGroupSection = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-7dfe209c"]]);
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d3547da8><button class="button"${ssrRenderAttr("aria-controls", groupId.value)}${ssrRenderAttr("aria-expanded", isOpen2.value)} data-v-d3547da8><span class="button-text" data-v-d3547da8>${__props.text ?? ""}</span><span class="vpi-plus button-icon" data-v-d3547da8></span></button><div${ssrRenderAttr("id", groupId.value)} class="items" data-v-d3547da8><!--[-->`);
      ssrRenderList(__props.items, (item) => {
        _push(`<!--[-->`);
        if ("link" in item) {
          _push(`<div class="item" data-v-d3547da8>`);
          ...
          _push(`<div class="group" data-v-d3547da8>`);
...
const VPNavScreenMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-d3547da8"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(localeLinks).length && unref(currentLang).label) {
        ...
        }, _attrs))} data-v-6d36fd2d><button class="title" data-v-6d36fd2d><span class="vpi-languages icon lang" data-v-6d36fd2d></span> ${ssrInterpolate(unref(currentLang).label)} <span class="vpi-chevron-down icon chevron" data-v-6d36fd2d></span></button><ul class="list" data-v-6d36fd2d><!--[-->`);
        ssrRenderList(unref(localeLinks), (locale) => {
          _push(`<li class="item" data-v-6d36fd2d>`);
          _push(ssrRenderComponent(_sfc_main$10, {
            class: "link",
            href: locale.link,
            lang: locale.lang,
...
const VPNavScreenTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-6d36fd2d"]]);
const _sfc_main$h = /* @__PURE__ */ defineComponent({
  __name: "VPNavScreen",
  __ssrInlineRender: true,
  props: {
...
const VPNavScreen = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-3309f4f1"]]);
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  __name: "VPNav",
  __ssrInlineRender: true,
  setup(__props) {
...
const VPNav = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-d5bf7c8e"]]);
const _sfc_main$f = /* @__PURE__ */ defineComponent({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.item.text) {
              _push2(`<div class="item"${ssrRenderAttr("role", itemRole.value)}${ssrRenderAttr("tabindex", __props.item.items && 0)} data-v-6b36a2fd${_scopeId}><div class="indicator" data-v-6b36a2fd${_scopeId}></div>`);
              ...
              if (__props.item.collapsed != null && __props.item.items && __props.item.items.length) {
                _push2(`<div class="caret" role="button" aria-label="toggle section" tabindex="0" data-v-6b36a2fd${_scopeId}><span class="vpi-chevron-right caret-icon" data-v-6b36a2fd${_scopeId}></span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (__props.item.items && __props.item.items.length) {
              _push2(`<div class="items" data-v-6b36a2fd${_scopeId}>`);
              if (__props.depth < 5) {
                _push2(`<!--[-->`);
...
const VPSidebarItem = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-6b36a2fd"]]);
const _sfc_main$e = /* @__PURE__ */ defineComponent({
...
const VPSidebarGroup = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-a84b7c21"]]);
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  __name: "VPSidebar",
  __ssrInlineRender: true,
  props: {
...
const VPSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-49f51a23"]]);
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  __name: "VPSkipLink",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><span tabindex="-1" data-v-10d4d845></span><a href="#VPContent" class="VPSkipLink visually-hidden" data-v-10d4d845>${ssrInterpolate(unref(theme2).skipToContentLabel || "Skip to content")}</a><!--]-->`);
    };
  }
});
const _sfc_setup$c = _sfc_main$c.setup;
...
const VPSkipLink = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-10d4d845"]]);
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "Layout",
  __ssrInlineRender: true,
  setup(__props) {
...
const Layout = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-c109192d"]]);
const GridSettings = {
  xmini: [[0, 2]],
  mini: [],
  small: [
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.message) {
        _push(`<h2 class="message" data-v-d74490aa>${ssrInterpolate(__props.message)}</h2>`);
      } else {
        _push(`<!---->`);
      }
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-f3186dc2><div class="profile" data-v-f3186dc2><figure class="avatar" data-v-f3186dc2><img class="avatar-img"${ssrRenderAttr("src", __props.member.avatar)}${ssrRenderAttr("alt", __props.member.name)} data-v-f3186dc2></figure><div class="data" data-v-f3186dc2><h1 class="name" data-v-f3186dc2>${ssrInterpolate(__props.member.name)}</h1>`);
      if (__props.member.title || __props.member.org) {
        _push(`<p class="affiliation" data-v-f3186dc2>`);
        if (__props.member.title) {
          _push(`<span class="title" data-v-f3186dc2>${ssrInterpolate(__props.member.title)}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.member.title && __props.member.org) {
          _push(`<span class="at" data-v-f3186dc2> @ </span>`);
        } else {
          _push(`<!---->`);
        }
      ...
      if (__props.member.desc) {
        _push(`<p class="desc" data-v-f3186dc2>${__props.member.desc ?? ""}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.member.links) {
        _push(`<div class="links" data-v-f3186dc2>`);
      ...
      if (__props.member.sponsor) {
        _push(`<div class="sp" data-v-f3186dc2>`);
        _push(ssrRenderComponent(_sfc_main$10, {
          class: "sp-link",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="vpi-heart sp-icon" data-v-f3186dc2${_scopeId}></span> ${ssrInterpolate(__props.member.actionText || "Sponsor")}`);
            } else {
              return [
...
const VPTeamMembersItem = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-f3186dc2"]]);
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-48117e83><div class="container" data-v-48117e83><!--[-->`);
      ssrRenderList(__props.members, (member) => {
        _push(`<div class="item" data-v-48117e83>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<a${ssrRenderAttrs(mergeProps({
        style: { "background": "var(--vp-c-bg-soft)", "border-radius": "16px", "padding": "16px", "box-shadow": "0 1px 2px 0 rgba(0, 0, 0, 0.05)", "transition": "all 0.3s ease", "display": "flex", "align-items": "center", "gap": "16px", "height": "100px" },
        href: unref(data).link,
        target: "_blank"
      }, _attrs))}><div style="${ssrRenderStyle({ "flex-shrink": "0", "width": "64px", "height": "64px", "display": "flex", "align-items": "center", "justify-content": "center", "overflow": "hidden" })}">`);
      if (unref(data).avatar && !imageFailed.value) {
        _push(`<img style="${ssrRenderStyle({
          width: "100%",
          height: "100%",
          objectFit: unref(data).irregular ? "contain" : "cover",
          borderRadius: unref(data).avatar?.startsWith("https://vitepress.dev/") ? "0" : "50%",
          transition: "all 0.3s ease"
        })}"${ssrRenderAttr("src", unref(data).avatar)}${ssrRenderAttr("alt", unref(data).name)}>`);
      } else {
        _push(`<div style="${ssrRenderStyle({ "background": "var(--vp-c-brand)", "width": "100%", "height": "100%", "display": "flex", "align-items": "center", "justify-content": "center", "border-radius": "50%", "font-size": "24px", "font-weight": "bold", "color": "white", "transition": "all 0.3s ease" })}">${ssrInterpolate(unref(data).name.charAt(0).toLocaleUpperCase())}</div>`);
      }
      _push(`</div><div style="${ssrRenderStyle({ "flex": "1", "min-width": "0", "display": "flex", "flex-direction": "column", "justify-content": "center", "transition": "all 0.3s ease" })}"><h3 style="${ssrRenderStyle({ "margin-bottom": "8px", "width": "100%", "white-space": "nowrap", "overflow": "hidden", "text-overflow": "ellipsis", "font-size": "16px", "font-weight": "600", "color": "var(--vp-c-text-1)" })}">${ssrInterpolate(unref(data).name)}</h3><div style="${ssrRenderStyle({ "color": "var(--vp-c-text-2)", "width": "100%", "overflow": "hidden", "font-size": "14px", "line-height": "1.5", "font-weight": "400", "word-break": "break-word", "display": "-webkit-box", "-webkit-line-clamp": "2", "-webkit-box-orient": "vertical" })}"${ssrRenderAttr("title", unref(data).descr)}>${ssrInterpolate(unref(data).descr)}</div></div></a>`);
    };
  }
});
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/WLink/LinkSite.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        id: "main",
        style: { "max-width": "80rem", "margin": "0 auto", "padding": "24px", "padding-bottom": "32px", "width": "100%" }
      }, _attrs))}><h1 style="${ssrRenderStyle({ "font-size": "24px", "font-weight": "bold", "margin-bottom": "48px", "color": "var(--vp-c-text-1)" })}">我的友链</h1><div style="${ssrRenderStyle({ "margin-bottom": "48px" })}"><!--[-->`);
      ssrRenderList(linksData.value, (item, index) => {
        _push(`<div class="link"><div style="${ssrRenderStyle({ "position": "relative", "margin-top": "48px", "margin-bottom": "24px", "height": "1px", "background": "var(--vp-c-border)" })}"><h3 style="${ssrRenderStyle({ "position": "absolute", "top": "50%", "left": "50%", "transform": "translate(-50%, -50%)", "background": "var(--vp-c-bg)", "padding": "0 24px", "text-align": "center", "font-size": "20px", "font-weight": "bold", "color": "var(--vp-c-text-1)" })}">${ssrInterpolate(item.title)}</h3></div><p style="${ssrRenderStyle({ "margin-bottom": "32px", "text-align": "center", "font-weight": "500", "color": "var(--vp-c-text-2)" })}">${ssrInterpolate(item.desc)}</p><div class="linkContainer" style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "repeat(1, 1fr)", "gap": "24px", "grid-auto-rows": "minmax(100px, auto)" })}"><!--[-->`);
        ssrRenderList(item.list, (temp) => {
          _push(`<div style="${ssrRenderStyle({ "grid-column": "span 1" })}">`);
          _push(ssrRenderComponent(_sfc_main$1, { data: temp }, null, _parent));
          _push(`</div>`);
        });
        _push(`<!--]--></div></div>`);
      });
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/WLink/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RawTheme = {
  ...theme,
  enhanceApp({ app }) {
    app.component("WLink", _sfc_main);
  }
};
